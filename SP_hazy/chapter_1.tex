...
This application mainly focuses on the air pollution caused by traffic in the Philippines, where the researchers reside as of writing the paper. Thus, it will only be set up and used on the vehicles that travel within the country. The researchers will be limited to the amount of vehicles that are present within the database that will be used for the application. Any other information that is not present in the database will not be included in the application. Among the components of air pollutants, this study is limited to using \ch{CO2} as the emission to be identified from the vehicles. Furthermore, This study will be utilizing the YOLOv5 object identification framework  and is thus limited to the features of that version. Any other features and upgrades that are present in future versions of the framework will not be included in the study.
